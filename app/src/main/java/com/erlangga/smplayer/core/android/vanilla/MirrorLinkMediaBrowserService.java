...
public class MirrorLinkMediaBrowserService extends MediaBrowserService
	...
	private static final String CUSTOM_ACTION_REPEAT = "com.erlangga.smplayer.core.android.vanilla.REPEAT";
	// Action to change the repeat mode
	private static final String CUSTOM_ACTION_SHUFFLE = "com.erlangga.smplayer.core.android.vanilla.SHUFFLE";
	...
	private List<MediaItem> mQueryResult = new ArrayList<MediaItem>();

	private final List<MediaItem> mMediaRoot = new ArrayList<MediaItem>();
	...
	public void onCreate() {
		...
		mMediaRoot.add(new MediaItem(
				new MediaDescription.Builder()
					.setMediaId(Integer.toString(MediaUtils.TYPE_ARTIST))
					.setTitle(getString(R.string.artists))
					.setIconUri(Uri.parse("android.resource://" +
							"com.erlangga.smplayer.core.android.vanilla/drawable/ic_menu_music_library"))
	...
	private void runQuery(List<MediaItem> populateMe, int mediaType, MediaAdapter adapter) {
		populateMe.clear();
		try {
			...
			final int flags = (mediaType == MediaUtils.TYPE_SONG || mediaType == MediaUtils.TYPE_PLAYLIST) ? MediaItem.FLAG_PLAYABLE : MediaItem.FLAG_BROWSABLE;
