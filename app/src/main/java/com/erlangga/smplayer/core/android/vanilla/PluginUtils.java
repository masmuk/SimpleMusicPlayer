...
public class PluginUtils {
    ...
    public static final String ACTION_REQUEST_PLUGIN_PARAMS = "com.erlangga.smplayer.core.android.vanilla.action.REQUEST_PLUGIN_PARAMS"; // broadcast
    public static final String ACTION_HANDLE_PLUGIN_PARAMS = "com.erlangga.smplayer.core.android.vanilla.action.HANDLE_PLUGIN_PARAMS"; // answer
    public static final String ACTION_LAUNCH_PLUGIN = "com.erlangga.smplayer.core.android.vanilla.action.LAUNCH_PLUGIN"; // targeted at selected by user

    // these are used by plugins to describe themselves
    public static final String EXTRA_PARAM_PLUGIN_NAME = "com.erlangga.smplayer.core.android.vanilla.extra.PLUGIN_NAME";
    public static final String EXTRA_PARAM_PLUGIN_APP = "com.erlangga.smplayer.core.android.vanilla.extra.PLUGIN_APP";
    public static final String EXTRA_PARAM_PLUGIN_DESC = "com.erlangga.smplayer.core.android.vanilla.extra.PLUGIN_DESC";

    // this is passed to plugin when it is selected by user
    public static final String EXTRA_PARAM_URI = "com.erlangga.smplayer.core.android.vanilla.extra.URI";
    public static final String EXTRA_PARAM_SONG_TITLE = "com.erlangga.smplayer.core.android.vanilla.extra.SONG_TITLE";
    public static final String EXTRA_PARAM_SONG_ALBUM = "com.erlangga.smplayer.core.android.vanilla.extra.SONG_ALBUM";
    public static final String EXTRA_PARAM_SONG_ARTIST = "com.erlangga.smplayer.core.android.vanilla.extra.SONG_ARTIST";

    static final String EXTRA_PLUGIN_MAP = "com.erlangga.smplayer.core.android.vanilla.internal.extra.PLUGIN_MAP";
